...
echo color("green","| By : DenVin |\n");
echo color("blue","| fanspage :ganteng dan manis|\n");
echo color("yellow","| Creator : dedenfatchurochman          |\n");
echo "| Kata sambutan : semoga vouchernya keluar dan deden fatchurochman mendapat rejeki yang lebih baik     |\n";
...
// function change(){
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-CJKBSG4"}');
        $message1 = fetch_value($goride,'"message":"','"');
        echo "\n".color("red","+] Message: ".$message1);
        echo "\n".color("blue","!] Claim voc PLATFORMREFFERAL");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
